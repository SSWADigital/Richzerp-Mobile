...
class order_detail2 extends StatefulWidget {
  const order_detail2({required this.id_reg});
  final String id_reg;
  @override
  _order_detail2State createState() => _order_detail2State();
}

class _order_detail2State extends State<order_detail2>
