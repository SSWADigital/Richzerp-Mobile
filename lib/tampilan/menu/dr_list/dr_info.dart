...
class detail_dr extends StatefulWidget {
  const detail_dr({required this.list, required this.namaKlinik});
  final dynamic list;
  final String namaKlinik;

  @override
  _detail_drState createState() => _detail_drState();
}

class _detail_drState extends State<detail_dr>
  ...
  Future dokter_klinik_() async {
    final Response = await http
      ...
      "aksi": "12",
      "id_dep": "01010317",
      "poli_id": widget.list[widget.list]['id_poli'] ?? ""
    });

    if (Response.body == null) {
      if (this.mounted) {
        this.setState(() {
          print(widget.list[widget.list]['id_poli'] ?? "");
          print("data Null");
          setState(() {
            data_dok = null;
          });
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Spacer(),
                                          Text(
                                            jadwal['jadwal_dokter_jam_mulai'] ??
                                                "",
                                            style: TextStyle(
